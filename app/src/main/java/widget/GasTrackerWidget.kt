...
import com.example.jetpackglance.MainActivity
import com.example.jetpackglance.R
            ...
            Column(
                ...
                Row(
                    ...
                    TextGweiAndPrice(
                        ...
                        context.getString(
                            R.string.text_usd,
                            calculateGasPriceUsd(ethusd, lowGasPrice)
                        )
                    )
                }
                SpacerHeight8dp()
                Row(
                    ...
                    TextGweiAndPrice(
                        ...
                        context.getString(
                            R.string.text_usd,
                            calculateGasPriceUsd(ethusd, averageGasPrice)
                        )
                    )
                }
                SpacerHeight8dp()
                Row(
                    ...
                    TextGweiAndPrice(
                        ...
                        context.getString(
                            R.string.text_usd,
                            calculateGasPriceUsd(ethusd, highGasPrice)
                        )
                    )
                }
            }
